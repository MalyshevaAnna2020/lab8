...
public class ControlUpdate {
    ...
    public void setTexts(SpaceMarine spaceMarine){
        insertId.setText(String.valueOf(spaceMarine.getId()));
        insertName.setText(spaceMarine.getName());
        insertX.setText(String.valueOf(spaceMarine.getCoordinates().getX()));
        insertY.setText(String.valueOf(spaceMarine.getCoordinates().getY()));
        insertHealth.setText(String.valueOf(spaceMarine.getHealth()));
        insertHeartCount.setValue(spaceMarine.getHeartCount());
        insertAchievements.setText(spaceMarine.getAchievements());
        insertNameOfChapter.setText(spaceMarine.getChapter().getName());
        insertMarinesCount.setText(String.valueOf(spaceMarine.getChapter().getMarinesCount()));
        insertCategory.setValue(spaceMarine.getCategory());
    }
    @FXML
    ...
    private void update(){
        ...
        alert_0.setStyle("-fx-fill: #FF3333;");
        ...
        if (insert) {
            ...
            command.setKey(insertId.getText());
            ...
            try {
                ...
                if (option.equals("1")) {
                    ...
                    text.setText(resource.getString("space_marine") + " " +
                            resource.getString("with") + " " + insertId.getText() + " " +
                            resource.getString("update_spacemarine"));
                    ...
                    if (option.equals("2")) {
                        alert_0.setText(resource.getString("space_marine") + " " +
                                resource.getString("with") + " id=" + insertId.getText() + " " +
